...
def read_excel_days(file_bytes):
    ...
    days = []
    g = df.groupby("Datum")["Umsatz"].sum()

    for d, total in g.items():
        days.append((d, float(total), 0.0))
